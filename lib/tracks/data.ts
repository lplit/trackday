...
export const tracks: Track[] = [
  {
    ...
    country: "Italy",
    countryCode: "IT",
    highestMotorcycleCategory: "MotoGP",
    highestCarCategory: "FIA WEC",
    length: "5.245 km",
    turns: 15,
    leftTurns: 6,
    rightTurns: 9,
    ...
    surface: "Asphalt",
    elevation: "65m",
    motorcycleRecordLapTime: "1:15.144",
    motorcycleRecordLapDriver: "Francesco Bagnaia",
    carRecordLapTime: "1:39.000",
    carRecordLapDriver: "Luca Badoer",
    recordLap: {
      time: "1:15.144",
  ...
  },
  {
    ...
    country: "Belgium",
    countryCode: "BE",
    highestMotorcycleCategory: "Endurance World Championship",
    highestCarCategory: "Formula 1",
    length: "7.004 km",
    turns: 19,
    ...
    surface: "Asphalt",
    elevation: "103m",
    motorcycleRecordLapTime: "2:18.000",
    motorcycleRecordLapDriver: "Gregg Black",
    carRecordLapTime: "1:41.252",
    carRecordLapDriver: "Lewis Hamilton",
    recordLap: {
      time: "1:41.252",
  ...
  },
  {
    ...
    countryCode: "DE",
    highestMotorcycleCategory: "Endurance World Championship",
    highestCarCategory: "Nürburgring 24h",
    length: "20.832 km",
    turns: 154,
    ...
    surface: "Asphalt",
    elevation: "300m",
    motorcycleRecordLapTime: "7:10.000",
    motorcycleRecordLapDriver: "Valentino Rossi",
    carRecordLapTime: "6:43.300",
    carRecordLapDriver: "Timo Bernhard",
    recordLap: {
      time: "6:43.300",
  ...
  },
  {
    ...
    type: "Road Course",
    surface: "Asphalt",
    motorcycleRecordLapTime: "2:01.941",
    motorcycleRecordLapDriver: "Marc Marquez",
    carRecordLapTime: "1:24.303",
    carRecordLapDriver: "Lewis Hamilton",
    recordLap: {
      time: "1:24.303",
  ...
  },
  {
    ...
    country: "Italy",
    countryCode: "IT",
    highestMotorcycleCategory: "Superbike World Championship",
    highestCarCategory: "Formula 1",
    length: "5.793 km",
    turns: 11,
    ...
    type: "Road Course", 
    surface: "Asphalt",
    motorcycleRecordLapTime: "1:47.000",
    motorcycleRecordLapDriver: "Jonathan Rea",
    carRecordLapTime: "1:18.887",
    carRecordLapDriver: "Valtteri Bottas",
    recordLap: {
      time: "1:18.887",
      vehicle: "Formula 1 W12",
